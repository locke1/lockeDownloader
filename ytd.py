#!/usr/bin/env python
# This app turns youtube links into mp3s.q
# This program simplifies Aman Roy's original program:
# original code by Aman Roy: https://github.com/aman-roy/mp3_downloader
# credit goes to them
